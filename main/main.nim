...
const WIFI_PASSWORD  {.strdefine.}: string = "928890582vn"
...
proc wifiStart*() =
  ...
  eventRegister(WIFI_EVENT_STA_DISCONNECTED, onWifiDisconnect, nil)
  eventRegister(IP_EVENT_STA_GOT_IP, ipReceivedHandler, nil)
...
proc wifiStop*() =
  ...
  eventUnregister(WIFI_EVENT_STA_DISCONNECTED, onWifiDisconnect)
  eventUnregister(IP_EVENT_STA_GOT_IP, ipReceivedHandler)
